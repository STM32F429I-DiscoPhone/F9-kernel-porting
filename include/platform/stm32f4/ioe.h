#ifndef PLATFORM_STM32F4_IOE_H__
#define PLATFORM_STM32F4_IOE_H__
...
void ioe_gpio_init(void);
void ioe_i2c_init(void);
uint8_t ioe_tp_init(void);
uint8_t ioe_io_af_config(uint8_t pin, uint8_t enable);
