...
#include <platform/stm32f4/i2c.h>
...
void __USER_TEXT ioe_i2c_init(void)
{
...
void __USER_TEXT ioe_gpio_init(void)
{
...
uint8_t __USER_TEXT ioe_tp_init(void)
{
	uint8_t i = 0;
...
uint8_t __USER_TEXT ioe_io_af_config(uint8_t pin, uint8_t enable)
{
	uint8_t tmp = 0;
